...
## 3、SingleThreadExecution

## 4、不可变对象以及线程安全对象

## 5、Guraded Suspension模式
...
## 11、Two-Phase Termination设计模式

## 12、Thread-Specjfic Stoge模式

## 13、Active Object-接收任务异步消息的主动对象
...
## 8、锁——ReentrantLock、ReadWriteLock、StampedLock
